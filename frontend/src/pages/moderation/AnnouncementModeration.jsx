    ...
    <motion.div className="space-y-3" variants={containerVariants} initial="hidden" animate="visible">
      ...
      <motion.div variants={itemVariants} className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-slate-800">Announcement Moderation</h1>
            <p className="text-slate-500 text-sm mt-0.5">Review and moderate announcements</p>
          </div>
        </div>
      </motion.div>

      {/* Status Filter and Bulk Actions */}
      <motion.div variants={itemVariants} className="flex items-center justify-between gap-3 border-b pb-2 flex-wrap">
        ...
        {status === 'PENDING' && (
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 text-sm font-medium rounded-lg transition-colors bg-slate-100 text-slate-700 hover:bg-slate-200"
            >
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-slate-600 mb-3 line-clamp-2">{announcement.content?.substring(0, 150)}...</p>
