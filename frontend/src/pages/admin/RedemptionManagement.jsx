  ...
  return (
    <motion.div className="space-y-3" variants={containerVariants} initial="hidden" animate="visible">
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-h1 text-slate-800">Redemption Management</h1>
          <p className="text-slate-500 text-caption mt-0.5">Manage reward redemption requests</p>
        </div>
      </motion.div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    {redemption.status === 'REJECTED' && redemption.rejectionReason && (
                      <div className="p-2 bg-red-50 border border-red-200 rounded text-caption text-red-700 mb-2">
                        <strong>Rejection Reason:</strong> {redemption.rejectionReason}
                      </div>
                    )}

                    {(redemption.approvedBy || redemption.processedBy) && (
                      <div className="text-overline text-slate-500">
      ...
      {showRejectDialog && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          ...
          >
            <h3 className="text-h2 text-slate-900 mb-4">Reject Redemption</h3>
