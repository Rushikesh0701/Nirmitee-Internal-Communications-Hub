...
const EditBlog = () => {
  ...
  useEffect(() => {
    if (blogData) {
        // Check if user can edit - handle both object and string authorId
        const blogAuthorId = blogData.authorId?._id || blogData.authorId || blogData.authorId?.toString();
        const userId = user?._id || user?.id;
        const isOwner = blogAuthorId && userId && blogAuthorId.toString() === userId.toString();
